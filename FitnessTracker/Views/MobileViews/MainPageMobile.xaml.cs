...
namespace FitnessTracker
{
    public partial class MainPageMobile : ContentPage
    {
        ...
        public MainPageMobile(PhysicalInfo physicalInfoviewmodel,PersonalInfo personalInfoviewModel)
        {
            InitializeComponent();
        ...
        void AddIcon_Clicked(object sender, EventArgs e)
        {
            ...
            {
                Navigation.PushAsync(new AddActivityPageMobile(viewModel));
            }
        }
        ...
        {
            Navigation.PushAsync(new TrackActivityMobile());
            addButton.IsVisible = true;
            overlayGrid.IsVisible = floatingButtonGrid.IsVisible = false;
        }
        ...
        {
            Navigation.PushAsync(new EditProfilePageMobile(_physicalInfoViewmodel, _personalInfoViewModel));
        }
        ...
        {
            Navigation.PushAsync(new HelpPageMobile());
        }
