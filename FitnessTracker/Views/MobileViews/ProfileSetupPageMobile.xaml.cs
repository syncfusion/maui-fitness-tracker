...
public partial class ProfileSetupPageMobile : ContentPage
{
    #region List
    ...
    public ProfileSetupPageMobile(PersonalInfo personalInfoviewmodel,PhysicalInfo physicalInfoviewmodel)
	{
		InitializeComponent();
    ...
    void FinishsetupButton_Clicked(object sender, EventArgs e)
    {
        ...
        Navigation.PushAsync(new MainPageMobile(viewModel,personalInfo));
    }
